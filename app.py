...
for i in raw_data[1:]:
  ...
  if new_data['type'] == 'topic':
    ...
    if parent_co:
      (new_data['longitude'], new_data['latitude']) = gen_co(parent_co, 100, new_data['relevance'], 100)
    ...
    if parent_co:
      (new_data['longitude'], new_data['latitude']) = gen_co(parent_co, 1, new_data['relevance'], 1)
